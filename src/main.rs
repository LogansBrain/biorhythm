...
fn main() {
    ...
    let today_date:NaiveDate = Local::now().date_naive();
    ...
    while days < 30 {
        ...
        let phy: i32 = (f64::sin(2.0 * std::f64::consts::PI * (days_alive as f64 + days as f64) / 23.0) * 20.0) as i32;
        let emo: i32 = (f64::sin(2.0 * std::f64::consts::PI * (days_alive as f64 + days as f64) / 28.0) * 20.0) as i32;
        let int: i32 = (f64::sin(2.0 * std::f64::consts::PI * (days_alive as f64 + days as f64) / 33.0) * 20.0) as i32;
